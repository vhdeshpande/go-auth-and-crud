...
// Graph is the type for graphql operations
type Graph struct {
	Movies      []*models.Movie
	QueryString string
...
func New(movies []*models.Movie) *Graph {
	// describe data as in database
	// define the object for the movie.
	...
	var fields = graphql.Fields{
		"list": &graphql.Field{
			...
			// what happens when tha action is exectude
	...
	// return pointer to the Graph type, populated with the correct information
	return &Graph{
		Movies:    movies,
		fields:    fields,
		movieType: movieType,
